...
export const about = {
  ...
  services: [
    { id: 'web', title: 'Web Applications', description: 'Responsive product interfaces with React.js, Next.js, TypeScript, and Tailwind CSS.', icon: 'code', accent: 'purple' },
    { id: 'backend', title: 'Backend & APIs', description: 'REST APIs, authentication, data models, and business logic with Node.js, Express.js, and Laravel.', icon: 'server', accent: 'blue' },
    { id: 'mobile', title: 'Mobile Applications', description: 'Cross-platform mobile experiences with React Native and Expo.', icon: 'phone', accent: 'cyan' },
    { id: 'quality', title: 'Performance & Delivery', description: 'Query optimization, code review, CI/CD pipelines, and AWS deployments.', icon: 'gauge', accent: 'purple' },
  ],
};
...
export const skills = [
  ...
  { id: 'rest', name: 'REST API Design', category: 'backend', icon: 'api', color: '#3B82F6' },
  { id: 'realtime', name: 'WebSockets / Socket.IO', category: 'backend', icon: 'api', color: '#8B5CF6' },
  ...
  { id: 'git', name: 'Git & GitHub', category: 'tools', icon: 'github', color: '#8B5CF6' },
  { id: 'cicd', name: 'CI/CD Pipelines', category: 'tools', icon: 'gauge', color: '#22D3EE' },
...
export const projects = [
  {
    ...
    image: '/assets/images/project-commerce-dashboard.svg', accent: 'purple', technologies: ['React.js', 'Laravel', 'MySQL', 'Pusher', 'Laravel Echo', 'REST APIs'],
  ...
  },
  {
    ...
    image: '/assets/images/project-portfolio-cms.svg', accent: 'cyan', technologies: ['PHP', 'JavaScript', 'Bootstrap', 'REST APIs', 'CMS', 'CSS Grid', 'Flexbox'],
  ...
  },
  {
    ...
    image: '/assets/images/project-chat-app.svg', accent: 'purple', technologies: ['React Native (Expo)', 'Laravel', 'MySQL', 'Laravel Sanctum', 'Zustand', 'REST APIs', 'Figma'],
  ...
  },
  {
    ...
    image: '/assets/images/project-chat-app.svg', accent: 'blue', technologies: ['MongoDB', 'Express.js', 'React.js', 'Node.js', 'TypeScript', 'Socket.IO', 'Tailwind CSS'],
